...
# ser aceito.
current_users = ['lari', 'peruano', 'dunga', 'admin', 'lelinho', 'oscar']
new_users = ['lari', 'gui', 'will', 'kaio', 'LELINHO', 'bernardo']

for new_user in new_users:
    if new_user.lower() in current_users:
        print('Usuário {}'.format(new_user) + ' já em uso, informe um novo nome.')
    else:
        (print('Usuário {}'.format(new_user) + ' cadastrado com sucesso'))
